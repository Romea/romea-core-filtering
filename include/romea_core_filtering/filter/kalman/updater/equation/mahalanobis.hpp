...
#ifndef ROMEA_CORE_FILTERING__FILTER__KALMAN__UPDATER__EQUATION__MAHALANOBIS_HPP_
#define ROMEA_CORE_FILTERING__FILTER__KALMAN__UPDATER__EQUATION__MAHALANOBIS_HPP_
...
struct KFMahalanobis
{
    ...
    Eigen::Matrix<Scalar, ObservationDIM, ObservationDIM> & QInnInverse)
  {
    ...
    QInnInverse =
      QInn.ldlt().solve(Eigen::Matrix<Scalar, ObservationDIM, ObservationDIM>::Identity());
...
#endif  // ROMEA_CORE_FILTERING__FILTER__KALMAN__UPDATER__EQUATION__MAHALANOBIS_HPP_
