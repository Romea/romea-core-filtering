#ifndef ROMEA_CORE_FILTERING_PARTICLE_PARTICLEFILTERGAUSSIANUPDATERCORE_HPP_ 
#define ROMEA_CORE_FILTERING_PARTICLE_PARTICLEFILTERGAUSSIANUPDATERCORE_HPP_ 
...
//-----------------------------------------------------------------------------
template <typename Scalar, size_t StateDIM, size_t ObservationDIM>
PFGaussianUpdaterCore<Scalar, StateDIM, ObservationDIM>::
PFGaussianUpdaterCore(const std::size_t &numberOfParticles,
                      const double & maximalMahalanobisDistance):
...
PFGaussianUpdaterCore<Scalar, StateDIM, ObservationDIM>::
  computeInnovation_(const Observation & observation,
...
//-----------------------------------------------------------------------------
template <typename Scalar, size_t StateDIM, size_t ObservationDIM>
bool PFGaussianUpdaterCore<Scalar, StateDIM, ObservationDIM>::
updateState_(State & state, const Observation & observation)
{
...
//-----------------------------------------------------------------------------
template <typename Scalar, size_t StateDIM>
PFGaussianUpdaterCore<Scalar, StateDIM, 1>::
PFGaussianUpdaterCore(const std::size_t &numberOfParticles,
                      const double & maximalMahalanobisDistance): 
...
//-----------------------------------------------------------------------------
template <typename Scalar, size_t StateDIM>
void PFGaussianUpdaterCore<Scalar, StateDIM, 1>::
computeInnovation_(const Observation & observation,
...
//-----------------------------------------------------------------------------
template <typename Scalar, size_t StateDIM>
bool PFGaussianUpdaterCore<Scalar, StateDIM, 1>::
updateState_(State & state, const Observation & observation)
{
  computeInnovation_(observation, state.weights);
...
#endif  // ROMEA_CORE_FILTERING_PARTICLE_PARTICLEFILTERGAUSSIANUPDATERCORE_HPP_ 
