#ifndef romea_UnscentedKalmanCorrelation_hpp
#define romea_UnscentedKalmanCorrelation_hpp

#include "../../GaussianState.hpp"
#include "../../GaussianObservation.hpp"
#include "../unscented_transform/UnscentedTransformParameters.hpp"

namespace romea {

//template<typename Scalar, size_t StateDIM, size_t ObservationDIM>
//inline Eigen::Matrix<Scalar,StateDIM,ObservationDIM> & operator=(Eigen::Matrix<Scalar,StateDIM,ObservationDIM> & matrix, Scalar value)
//{
...
{
  static void compute(const UnscentedTransformParameters<Scalar> & parameters,
